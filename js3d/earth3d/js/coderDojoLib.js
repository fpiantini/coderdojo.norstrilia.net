...
(function() {
    ...
    function cdRender3d(options) {
		...
		camera.position.y = 5;
		deltaTheta = (typeof options.theta === 'number' ? options.theta : 0.002);
...
//			var lt = p[1] + 360;
//			var lg = -p[0] + 360;
//			lt = (lt % 360) * Math.PI / 180;
//			lg = (lg % 360) * Math.PI / 180;
//			vertex1.x = Math.cos(lt) * Math.cos(lg);
//			vertex1.z = Math.cos(lt) * Math.sin(lg);
//			vertex1.y = Math.sin(lt);
//			vertex1.normalize();
...
//
//		  }
//		  material = new THREE.LineBasicMaterial( { color: 0xd07020, opacity: 0.8, linewidth: 2 } );
